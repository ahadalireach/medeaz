        ...
        return (
            <Modal isOpen={isOpen} onClose={onClose} title={t('profileNotFound')} size="md">
                <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h3 className="text-xl font-bold text-text-primary">{t('doctorNotFound')}</h3>
                    ...
                    <div className="flex-1 space-y-2">
                        ...
                        <div className="flex flex-wrap gap-6 pt-2">
                            <div className="flex items-center gap-2.5 text-sm font-bold text-text-primary">
                                ...
                                <span>{doctor.averageRating || "4.8"} <span className="text-text-secondary font-medium">({doctor.totalReviews || 0} {t('reviews')})</span></span>
                            </div>
                            <div className="flex items-center gap-2.5 text-sm font-bold text-text-primary">
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                    <div className="p-4 md:p-5 bg-background rounded-3xl border border-black/5 group hover:border-primary/20 transition-all">
                        <div className="flex items-center gap-3 mb-2 md:mb-3">
                            ...
                            <span className="text-[9px] md:text-[10px] font-black text-text-secondary uppercase tracking-widest">{t('location')}</span>
                        </div>
                    ...
                    <div className="p-4 md:p-5 bg-background rounded-3xl border border-black/5 group hover:border-primary/20 transition-all">
                        <div className="flex items-center gap-3 mb-2 md:mb-3">
                            ...
                            <span className="text-[9px] md:text-[10px] font-black text-text-secondary uppercase tracking-widest">{t('fee')}</span>
                        </div>
                    ...
                    <div className="p-4 md:p-5 bg-background rounded-3xl border border-black/5 group hover:border-primary/20 transition-all">
                        <div className="flex items-center gap-3 mb-2 md:mb-3">
                            ...
                            <span className="text-[9px] md:text-[10px] font-black text-text-secondary uppercase tracking-widest">{t('experience')}</span>
                        </div>
                        <p className="text-xs md:text-sm font-bold text-text-primary">
                    ...
                    <div className="p-4 md:p-5 bg-background rounded-3xl border border-black/5 group hover:border-primary/20 transition-all">
                        <div className="flex items-center gap-3 mb-2 md:mb-3">
                            ...
                            <span className="text-[9px] md:text-[10px] font-black text-text-secondary uppercase tracking-widest">{t('education')}</span>
                        </div>
                        <p className="text-xs md:text-sm font-bold text-text-primary truncate">
                    ...
                    <div className="p-4 md:p-5 bg-background rounded-3xl border border-black/5 group hover:border-primary/20 transition-all">
                        <div className="flex items-center gap-3 mb-2 md:mb-3">
                            ...
                            <span className="text-[9px] md:text-[10px] font-black text-text-secondary uppercase tracking-widest">{t('languages')}</span>
                        </div>
                        <p className="text-xs md:text-sm font-bold text-text-primary truncate">
                    ...
                    <div className="p-4 md:p-5 bg-background rounded-3xl border border-black/5 group hover:border-primary/20 transition-all">
                        <div className="flex items-center gap-3 mb-2 md:mb-3">
                            ...
                            <span className="text-[9px] md:text-[10px] font-black text-text-secondary uppercase tracking-widest">{t('contact')}</span>
                        </div>
                        <p className="text-xs md:text-sm font-bold text-text-primary">
                            {t('contactViaChat')}
                        </p>
