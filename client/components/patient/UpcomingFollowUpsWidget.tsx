...
export default function UpcomingFollowUpsWidget({ followUps }: { followUps: any[] }) {
    ...
    return (
        <div className="rounded-2xl border-l-4 border-l-primary border-y border-r border-black/5 dark:border-y-white/5 dark:border-r-white/5 bg-white p-6 dark:bg-[#18181b]">
            ...
            <div className="mt-6 flex flex-col gap-4">
                {followUps.map((followUp: any, index: number) => (
                    <div
                        ...
                        className="flex flex-col gap-3 rounded-xl border border-gray-100 bg-gray-50/50 p-4 transition-colors hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-800/50 dark:hover:bg-gray-800"
                    >
                        <div className="flex items-start justify-between">
                            ...
                            <div className="flex flex-col items-end gap-1 text-right">
                                <span className="rounded-full bg-primary/10 px-2.5 py-1 text-xs font-bold text-primary dark:bg-primary/20">
