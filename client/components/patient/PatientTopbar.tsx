                ...
                return (
                  ...
                  >
                    ...
                    {link.label === "Consultation Chat" &&
                      totalChatUnread > 0 && (
                        <span className={`${isRtl ? "mr-auto" : "ml-auto"} w-5 h-5 rounded-full bg-red-500 text-white text-[10px] font-bold flex items-center justify-center border-2 border-white`}>
