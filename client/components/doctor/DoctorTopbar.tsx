    ...
    return (
        <>
            <header className="lens-topbar h-16 border-b border-black/5 dark:border-white/5 bg-white/80 dark:bg-[#18181b]/80 backdrop-blur-md sticky top-0 z-40 px-4 sm:px-6 flex items-center justify-between w-full">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="h-10 w-10 text-text-secondary hover:bg-black/5 rounded-lg flex items-center justify-center relative transition-colors cursor-pointer group"
                    >
            ...
            <div className={`fixed inset-0 transition-all duration-500 ${isMenuOpen ? "visible" : "invisible"}`} style={{ zIndex: 100 }}>
                ...
                {/* Drawer Panel */}
                <div className={`absolute right-0 top-0 h-full w-full max-w-[90vw] sm:max-w-sm bg-white dark:bg-[#18181b] transition-transform duration-500 ease-out border-l border-black/10 dark:border-white/10 ${isMenuOpen ? "translate-x-0" : "translate-x-full"}`} style={{ zIndex: 101 }}>
