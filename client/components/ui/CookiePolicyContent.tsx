export default function CookiePolicyContent() {
    return (
        <div className="max-w-4xl mx-auto space-y-8 p-6 bg-white rounded-2xl border border-black/5">
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-text-primary">2. Essential Cookies</h2>
                <p className="text-text-secondary leading-relaxed">
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-text-primary">3. Analytics Cookies</h2>
                <p className="text-text-secondary leading-relaxed">
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-text-primary">4. Managing Your Preferences</h2>
                <p className="text-text-secondary leading-relaxed">
