      ...
      <div className="relative py-4">
        ...
        <div className="relative flex flex-col items-center text-center space-y-6">
          ...
          <div className="relative">
            ...
            <div className="h-24 w-24 bg-primary rounded-xl flex items-center justify-center text-white shadow-2xl shadow-primary/40 rotate-12 hover:rotate-0 transition-transform duration-500 animate-in zoom-in spin-in-12">
          ...
          <div className="w-full pt-4">
            <Button 
              ...
              className="w-full h-16 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] shadow-xl shadow-primary/25 hover:shadow-primary/40 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
              {actionText}
            </Button>
          </div>
