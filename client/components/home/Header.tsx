...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-background/85 backdrop-blur-md">
      <div 
        className={cn(
          "mx-auto px-4 sm:px-6 lg:px-8 min-h-20 py-3 flex items-center justify-between gap-y-2 flex-wrap",
        ...
        <div className="flex items-center gap-2 sm:gap-4 flex-wrap max-[550px]:hidden">
          ...
          <Link href="/login">
            <Button
              ...
              size="sm"
              className={cn(
                "h-10 px-4 text-sm font-bold transition-all hover:scale-105 active:scale-95 whitespace-nowrap",
          ...
          <Link href="/register">
            <Button
              size="sm"
              className={cn(
                "h-10 px-4 text-sm font-bold transition-all hover:scale-105 active:scale-95 shadow-md whitespace-nowrap",
                isUrdu && "font-urdu px-6 py-2 text-base leading-relaxed"
              )}
            >
