                ...
                <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 animate-in mt-12 mb-12">
                    <div className="text-center mb-16">
                        ...
                        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-6 tracking-tight">
                            {isUrdu ? "Med" : "About Med"}<span className="text-primary">Eaz</span>{isUrdu ? " کے بارے میں" : ""}
                        </h1>
                    ...
                    <div className="bg-primary/5 dark:bg-primary/5 rounded-3xl p-8 md:p-12 border border-primary/10 text-center">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">{isUrdu ? "آج ہی ہمارے نیٹ ورک کا حصہ بنیں" : "Join our network today."}</h2>
