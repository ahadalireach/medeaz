  ...
  return (
    <ChatSocketProvider>
      <div className="flex flex-col min-h-screen relative print:block" style={{ background: '#f6f8f8' }}>
        {/* Inline background pattern — absolute/relative works; fixed -z-10 is blocked by body background paint */}
        <svg className="absolute inset-0 w-full h-full pointer-events-none select-none z-0 print:hidden" xmlns="http://www.w3.org/2000/svg" aria-hidden>
          <defs>
            <pattern id="pat-diag" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
              <line x1="0" y1="0" x2="0" y2="60" stroke="#0F4C5C" strokeWidth="0.6"/>
            </pattern>
            <pattern id="pat-icons" x="0" y="0" width="320" height="320" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#pat-diag)" opacity="0.1"/>
          <rect width="100%" height="100%" fill="url(#pat-icons)" opacity="0.18"/>
        </svg>
