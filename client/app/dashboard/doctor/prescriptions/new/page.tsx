...
function NewPrescriptionInner() {
  ...
  const handleSubmit = async () => {
    ...
    const toastId = toast.loading(t('doctor.dashboard.newPrescription') + "...");
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8">
          ...
          {loadingPatients ? (
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[400px] overflow-y-auto p-2 mb-6">
                {patients.length > 0 ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-end gap-4">
              ...
              <button
                ...
                disabled={creating}
                className="px-8 py-4 bg-gradient-to-r from-primary to-primary-hover text-white rounded-xl font-bold hover:shadow-2xl transition-all disabled:opacity-50 flex items-center gap-2"
              >
                {creating ? (
                  <>
                    <Loader className="h-5 w-5 animate-spin" />
