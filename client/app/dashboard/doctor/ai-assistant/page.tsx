...
import { Send, Bot, Loader2, Mic, Square, Trash2, Stethoscope } from 'lucide-react';
...
export default function DoctorAIAssistantPage() {
  ...
  const [chatWithDoctorAI, { isLoading }] = useChatWithAIMutation();
      ...
      <div className="flex items-start justify-between mb-5">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl font-bold text-text-primary">Clinical AI Assistant</h1>
          </div>
          <p className="text-xs text-text-secondary ml-9">
            Drug info · Treatment protocols · Differential diagnosis · Clinical support
          </p>
        </div>
        <button
          onClick={clearChat}
          ...
          <div className="flex items-end gap-3">
            <div className="flex-1 relative">
              <textarea
                ...
                placeholder={isRecording ? 'Listening...' : 'Ask about drugs, diagnosis, protocols...'}
                rows={1}
