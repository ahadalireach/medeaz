  ...
  return (
    <div className="flex flex-col min-h-screen relative" style={{ background: '#f6f8f8' }}>
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none select-none z-0" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <defs>
          <pattern id="cln-diag" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
            <line x1="0" y1="0" x2="0" y2="60" stroke="#0F4C5C" strokeWidth="0.6"/>
          </pattern>
          <pattern id="cln-icons" x="0" y="0" width="320" height="320" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#cln-diag)" opacity="0.1"/>
        <rect width="100%" height="100%" fill="url(#cln-icons)" opacity="0.18"/>
      </svg>
