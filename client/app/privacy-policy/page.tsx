            ...
            <main className="flex-1 pt-20">
                <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 mt-12 mb-12">
                    <div className="mb-12">
                        ...
                        <h1 className="text-4xl md:text-5xl font-extrabold text-text-primary mb-6">{isUrdu ? "رازداری پالیسی" : "Privacy Policy"}</h1>
                        <p className="text-text-secondary text-sm font-semibold tracking-wider uppercase mb-8">{isUrdu ? "موثر تاریخ" : "Effective Date"}: {new Date().getFullYear()}</p>
                        ...
                        <div className="prose max-w-none text-text-primary text-lg leading-relaxed">
                            ...
                            <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">{isUrdu ? "1. ہم کون سی معلومات جمع کرتے ہیں" : "1. Information We Collect"}</h2>
                            ...
                            <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">{isUrdu ? "2. معلومات کا استعمال" : "2. How We Use the Info"}</h2>
                            ...
                            <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">{isUrdu ? "3. ڈیٹا سیکیورٹی" : "3. Data Integrity & Security"}</h2>
