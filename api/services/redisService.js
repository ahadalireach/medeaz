...
const getClinicOpsSession = async (userId) => {
  return await redisClient.get(`clinic_ops_session:${userId}`);
};
...
const getDoctorCopilotSession = async (userId) => {
  return await redisClient.get(`doctor_copilot_session:${userId}`);
};
...
const getPatientAssistantSession = async (userId) => {
  return await redisClient.get(`patient_assistant_session:${userId}`);
};
